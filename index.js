...
option = wrapper.querySelector(`.options`);
...
countries.forEach(country => {
    // Adding each country inside li and inserting all li inside the option
...
{
    // below line will select the very first child of selectBtn class and in that it will append the country name we clcik.
wrapper.classList.remove(`active`);
    selectBtn.firstElementChild.innerText = selectedCountry.innerText;
}
